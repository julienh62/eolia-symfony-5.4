 ...
 */
final class Version20230110112518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance CHANGE picture picture VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance CHANGE picture picture VARCHAR(255) DEFAULT NULL');
